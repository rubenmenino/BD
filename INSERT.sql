...
INSERT INTO projeto.Pessoa VALUES 
		('1961-03-26', '910707891', 'João Afonso', 'M', 198254059, 'joaoafonso@gmail.pt', 'Rua Jorge Sena 28'),
		('1961-09-18', '913433635', 'Ricardo Pereira', 'M', 176225153, 'ricardopereira@ua.pt', 'R Nogueiras 112'),
		('1962-07-17', '913918064', 'Ruben Menino', 'M', 171506707, 'ruben.menino@ua.pt', 'R Combatentes G Guerra 87'),
		('1964-01-29', '916478685', 'Gabriel Saudade', 'M', 195021711, 'gabrielsaudade@ua.pt', 'Rua Igreja 120'),
		('1966-03-17', '915554569', 'José Miguel', 'M', 125074948, 'josemiguel@outlook.pt', 'R Oliveirinhas 80'),
		('1968-11-11', '921227682', 'Guilherme Tomas', 'M', 179777203, 'gui@ua.pt', 'Rua do Carmo 1'),
		('1972-05-13', '927387927', 'Augusto Miguel', 'M', 174462379, 'augusto@hotmail.pt', 'Rua da Amélia 34'),
		('1974-06-01', '926433280', 'José Algarve', 'M', 133888452, 'zeze@ua.pt', 'Rua Andrade da Poeira 45'),
		('1975-03-31', '924539227', 'João Terra', 'M', 164930280, 'terrajoao@gmail.pt', 'Rua da Santissima Trindade 199'),
		('1976-06-22', '925001831', 'Gustavo Miguel', 'M', 169833623, 'miguelgustavo@ua.pt', 'Rua da forca 3'),
		('1976-08-03', '936946112', 'Florinda Leite', 'F', 118741080, 'florescasa@gmail.pt', 'Rua Professor Celso Santos 24'),
		('1979-04-13', '935528427', 'Maria Alfredo', 'F', 106426150, 'mariaalfredo@ua.pt', 'Rua da macierinha 2'),
		('1985-11-28', '938180364', 'Branca Barros', 'F', 184164702, 'brancadeneve@gmail.pt', 'Rua da venezuela 44'),
		('1987-09-14', '936404711', 'Marina Brum', 'F', 135860709, 'marianbubum@ua.pt', 'Rua da gafanha 3'),
		('1987-11-09', '931503621', 'Salomé Delgado', 'F', 145093360, 'salamedechocolate@hotmail.pt', 'Rua da gafanha da nazare 3'),
		('1994-05-09', '968413692', 'Sara Correia', 'F', 168387190, 'sarocas@ua.pt', 'Rua dos atletas 1'),
		('1996-05-05', '960053692', 'Joana Matos', 'F', 177730617, 'joaninha335@gmail.pt', 'Rua da escola 64'),
		('1997-07-21', '964382496', 'Juliana Pereira', 'F', 179959476, 'julianaperas@hotmail.pt', 'Rua do nada 1'),
		('1998-06-11', '964781004', 'Rafael Josefina', 'F', 115290540, 'rafaelamulher@outlook.pt', 'Rua Vazia 0'),
		('2000-02-08', '964521446', 'Márcia Joana', 'F', 198674503, 'joaninhamarciana@outlook.pt', 'Rua das nespereiras 69'
		);
DBCC CHECKIDENT([projeto.Pessoa], RESEED, 0)
SELECT * FROM projeto.Pessoa
WHERE Sexo = 'F'
